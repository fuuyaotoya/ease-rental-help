      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'キャンセル操作と Shopify 注文の同期',
              slug: 'appendix/cancellation-shopify-sync',
            },
            { label: '前日自動請求の仕組み', slug: 'appendix/auto-invoicing' },
            { label: '決済方法別伝票作成フロー', slug: 'appendix/payment-method-flows' },
