...
:::dev
> **SSOT:** Backend `src/modules/bookings/booking-totals.service.ts` `calculateCancellationFee()` / 営業日数は `calcCancelDaysBefore()`（Issue #2163） / Frontend `src/lib/utils/fee-calculator.ts`
:::
